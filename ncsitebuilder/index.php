<?php
	...
	$pages = array(
		'0'	=> array('id' => '3', 'alias' => '', 'file' => '3.php','controllers' => array()),
		'1'	=> array('id' => '1', 'alias' => '懶人減肥方法', 'file' => '1.php','controllers' => array()),
		'2'	=> array('id' => '2', 'alias' => '重量訓練', 'file' => '2.php','controllers' => array())
	);
	$forms = array(
	...
	$base_lang = 'en';
	$site_id = "4608f59b";
	$websiteUID = "66b6487d3fbc6ea10941de43adf548102dab53e0c9024947f67757a10f4bc677caa5c6a2e25cc1ef";
	$base_dir = dirname(__FILE__);
	$base_url = '/';
	$user_domain = 'calfitness.com.hk';
	$pretty_domain = 'calfitness.com.hk';
	$home_page = '3';
	$mod_rewrite = true;
	$show_comments = false;
	$comment_callback = "https://sitebuilder1.web-hosting.com:443/v3/comment_callback/";
	$user_key = "pdUyMw0kZhtkPf3IPcDmcKw=";
	$user_hash = "8f2e5165db6f716a";
